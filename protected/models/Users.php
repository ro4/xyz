...
class Users extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('birthday, reg_time, last_login', 'length', 'max'=>10),
			array('reg_ip, last_ip', 'length', 'max'=>15),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('uid, username, email, mobile, password, salt, avatar_file, sex, birthday, reg_time, reg_ip, last_login, last_ip', 'safe', 'on'=>'search'),
		);
	}
